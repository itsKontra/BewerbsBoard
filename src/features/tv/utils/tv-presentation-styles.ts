...
export const TV_PRESENTATION_STYLES: Record<TvTheme, TvPresentationStyle> = {
  ...
  outdoor: createTvPresentationStyle({
    ...
    tableHeaderCombinedAccent: 'text-orange-700',
    tableDivider: 'divide-slate-300',
    rowBase: 'bg-white even:bg-slate-200/90',
    rowRank1: 'border-l-4 border-l-amber-500 tv-leading-bar-1 bg-amber-200/85 even:bg-amber-200',
    rowRank2: 'tv-leading-bar-2 bg-slate-200 even:bg-slate-300/80',
    rowRank3: 'tv-leading-bar-3 bg-amber-100/95 even:bg-amber-200/70',
