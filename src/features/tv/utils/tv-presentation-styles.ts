...
export const TV_PRESENTATION_STYLES: Record<TvTheme, TvPresentationStyle> = {
  ...
  outdoor: createTvPresentationStyle({
    ...
    identityRail: 'border-slate-400 bg-white/95 shadow-md',
    headerSublabel: 'text-sky-800 font-bold',
    ...
    tableContainer: 'border-slate-400 bg-white shadow-2xl',
    tableHeader: 'border-b-2 border-slate-400 bg-slate-200 text-slate-950 font-black',
    tableHeaderCombinedAccent: 'text-orange-600',
    tableDivider: 'divide-slate-300',
    rowBase: 'bg-white even:bg-slate-200/90',
    rowRank1: 'border-l-4 border-l-amber-500 tv-leading-bar-1 bg-amber-100/70 even:bg-amber-100/85',
    rowRank2: 'tv-leading-bar-2 bg-slate-100 even:bg-slate-200/80',
    rowRank3: 'tv-leading-bar-3 bg-amber-50/80 even:bg-amber-100/60',
    rank1Number: 'text-amber-950 font-black',
    rank2Number: 'text-slate-900 font-black',
    rank3Number: 'text-amber-900 font-black',
    rankOtherNumber: 'text-slate-900 font-black',
    competitorName: 'text-slate-950 font-black',
    timeText: 'text-slate-950 font-black',
    penaltyText: 'text-white bg-red-600 font-black shadow-sm ring-1 ring-red-700',
    scoreTotal: 'text-orange-500 font-black',
    emptyTableMessage: 'text-slate-600 font-bold',
    upcomingBorder: 'border-t-4 border-t-sky-600',
    ...
    podiumTime: 'text-orange-500 font-black',
    podiumSteps: {
